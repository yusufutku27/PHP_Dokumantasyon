...
<body>
    ...
    */
	...
	$isimler=array("Yusuf","Ahmet","Ali","Mustafa");
	...
	$meyveler=["armut","elma","kiraz","kavun","avakado"];

	echo "<pre>";
	print_r($meyveler);
	echo "</pre>";

	/* Dizilerin verilerine indis (index) numaraları ile ulaşmak */
	
	echo $isimler[0]."'nin "."en sevdigi meyve ".$meyveler[2]."'dır.";
  
	/* Dizilerde biz kendimi indis degerleri verebiliriz vermezsek php otomatik rakamsal degerler verir */

	
	$personel=array("isim"=>"yusuf","soyisim"=>"utku","yas"=>20,"boy"=>1.79);

	echo "<pre>";
	print_r($personel);
	echo "</pre>";

	echo "Benim ismim ".$personel["isim"]." ".$personel["soyisim"]."'dur."."<br><br>";
	
	/* indis isimleri büyük küçük harf duyarlıdır. */

	$sebze=["yesil"=>"pırasa","yeSil"=>"marul","yEsil"=>"salatalık"];
