...
<body>
	...
	*/
    ...
    if (filter_var($deger, FILTER_VALIDATE_INT)) {
        echo "Bu deger intreger<br>";
    } else {
        echo "Bu deger integer degil<br>";
    }

    $ifade = "1";

    if (filter_var($ifade, FILTER_VALIDATE_BOOLEAN)) {
        echo "Evet bu bir boolean veri türünde bir degerdir";
    } else {
        echo "Hayır bu deger boolean veri türünde bir deger degildir";
    }

    // Not:İhtiyaca göre açıklamadaki parametler kullanılır
