...
<body>
	...
	*/
    ...
    $kelime = "yusuf utku";
    $buyukyap = mb_strtoupper($kelime);

    echo $buyukyap . "<br>";

    $isim = "MUSTAFA İSABAŞ";
    $kucukyap = mb_strtolower($isim); // türkçe karakterleride küçük harfe dönüşürdü
    echo $kucukyap . "<br>";


    // Normalde mb_ kullanmasakta işlem yapar ama türkçe karakterli dönüştürmez bu yüzden mb_ ön eki ile kullan


    $mesaj = "merhaba Yusuf nasılsın İYİMİSİN";
    $sonuc = mb_convert_case($mesaj, MB_CASE_UPPER);
    echo $sonuc;
